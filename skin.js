...
// Pano2VR 6.0.4/17319
// Filename: TLC_simplex_v6.ggsk
// Generated 2019-08-24T12:05:36
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		elHorScrollBg.setAttribute('style', 'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 1600px; height: 15px; background-color: rgba(255,255,255,0.392157); pointer-events: auto;');
		elHorScrollBg.className='ggskin ggskin_scrollarea_hscrollbg';
		elHorScrollFg = me._thumbnail_menu__horScrollFg = document.createElement('div');
		elHorScrollBg.appendChild(elHorScrollFg);
		elHorScrollFg.className='ggskin ggskin_scrollarea_hscrollfg';
		elHorScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 1600px; height: 15px; background-color: rgba(255,255,255,1); pointer-events: auto;');
		...
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 800px; background-color: rgba(255,255,255,0.392157); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._thumbnail_menu_mobile__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 800px; background-color: rgba(255,255,255,1); pointer-events: auto;');
		...
		hs='data:image/jpeg;base64,'+
			''+
		...
		el=me._logo_tlc=document.createElement('div');
		el.ggFilter = '';
		el.ggFilteredIds = [];
		el.ggId="LOGO TLC";
		...
		me._logo_tlc.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._logo_tlc.onclick=function (e) {
			player.openUrl("http:\/\/tuanle.com.vn\/en\/","");
		}
		me._logo_tlc.ggUpdateConditionResize=function () {
			var mapDetails = player.getMapDetails(me._logo_tlc.ggMapId);
			if (!(mapDetails.hasOwnProperty('title'))) return;
			me._logo_tlc.ggCalculateFloorplanSize(mapDetails);
			me._logo_tlc.ggShowSimpleFloorplan(mapDetails);
			me._logo_tlc.ggPlaceMarkersOnSimpleFloorplan();
			me._logo_tlc.ggRadar.update();
		}
		me._logo_tlc.ggUpdateConditionTimer=function () {
			me._logo_tlc.ggRadar.update();
		}
		me._logo_tlc.ggUpdatePosition=function (useTransition) {
			me._logo_tlc.ggUpdateConditionResize();
		}
		me._logo_tlc.ggNodeChange=function () {
			var mapDetails = player.getMapDetails(me._logo_tlc.ggMapId);
			if (!(mapDetails.hasOwnProperty('title'))) return;
			me._logo_tlc.ggCalculateFloorplanSize(mapDetails);
			me._logo_tlc.ggShowSimpleFloorplan(mapDetails);
			me._logo_tlc.ggPlaceMarkersOnSimpleFloorplan();
			me._logo_tlc.ggRadar.update();
			if (me._logo_tlc.ggLastNodeId) {
				var lastActiveMarker = me._logo_tlc.ggSimpleFloorplanMarkerArray[me._logo_tlc.ggLastNodeId];
				if (lastActiveMarker && lastActiveMarker.ggDeactivate) lastActiveMarker.ggDeactivate();
			}
			var id = player.getCurrentNode();
			var marker = me._logo_tlc.ggSimpleFloorplanMarkerArray[id];
			if (marker) {
				if (marker.ggActivate) marker.ggActivate();
			}
			me._logo_tlc.ggLastNodeId = id;
		}
		me.divSkin.appendChild(me._logo_tlc);
		el=me._logo_rgf=document.createElement('div');
		el.ggFilter = '';
		el.ggFilteredIds = [];
		el.ggId="LOGO RGF";
		el.ggParameter={ rx:0,ry:0,a:0,sx:0.8,sy:0.8 };
		...
		el.style[domTransform + 'Origin']='50% 50%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		me._logo_rgf.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._logo_rgf.ggUpdateConditionResize=function () {
			var mapDetails = player.getMapDetails(me._logo_rgf.ggMapId);
			if (!(mapDetails.hasOwnProperty('title'))) return;
			me._logo_rgf.ggCalculateFloorplanSize(mapDetails);
			me._logo_rgf.ggShowSimpleFloorplan(mapDetails);
			me._logo_rgf.ggPlaceMarkersOnSimpleFloorplan();
			me._logo_rgf.ggRadar.update();
		}
		me._logo_rgf.ggUpdateConditionTimer=function () {
			me._logo_rgf.ggRadar.update();
		}
		me._logo_rgf.ggUpdatePosition=function (useTransition) {
			me._logo_rgf.ggUpdateConditionResize();
		}
		me._logo_rgf.ggNodeChange=function () {
			var mapDetails = player.getMapDetails(me._logo_rgf.ggMapId);
			if (!(mapDetails.hasOwnProperty('title'))) return;
			me._logo_rgf.ggCalculateFloorplanSize(mapDetails);
			me._logo_rgf.ggShowSimpleFloorplan(mapDetails);
			me._logo_rgf.ggPlaceMarkersOnSimpleFloorplan();
			me._logo_rgf.ggRadar.update();
			if (me._logo_rgf.ggLastNodeId) {
				var lastActiveMarker = me._logo_rgf.ggSimpleFloorplanMarkerArray[me._logo_rgf.ggLastNodeId];
				if (lastActiveMarker && lastActiveMarker.ggDeactivate) lastActiveMarker.ggDeactivate();
			}
			var id = player.getCurrentNode();
			var marker = me._logo_rgf.ggSimpleFloorplanMarkerArray[id];
			if (marker) {
				if (marker.ggActivate) marker.ggActivate();
			}
			me._logo_rgf.ggLastNodeId = id;
		}
		me.divSkin.appendChild(me._logo_rgf);
		me._popup_video_file.ggVideoSource = 'media/';
		me._popup_video_file.ggVideoNotLoaded = true;
		...
		me._popup_video_youtube.ggVideoNotLoaded = true;
		me._logo_tlc.ggMarkerInstances=[];
		me._logo_tlc.ggMapId = 'FloorPlan02';
		me._logo_tlc.ggLastNodeId=null;
		me._logo_tlc.ggSimpleFloorplanMarkerArray=[];
		me._logo_tlc.ggFloorplanWidth=0;
		me._logo_tlc.ggFloorplanHeight=0;
		me._logo_tlc__mapdiv=document.createElement('div');
		me._logo_tlc__mapdiv.className='ggskin ggskin_map';
		me._logo_tlc.appendChild(me._logo_tlc__mapdiv);
		me._logo_tlc__img=document.createElement('img');
		me._logo_tlc__img.className='ggskin ggskin_map';
		me._logo_tlc__mapdiv.appendChild(me._logo_tlc__img);
		me._logo_tlc.ggRadar={ lastFov : -1, lastPan : -1, xPos : -1, yPos : -1, radarElement : null }
		me._logo_tlc.ggRadar.update=function() {
			var radar=me._logo_tlc.ggRadar;
			var d2r = Math.PI/180 ;
			var fov = player.getFov();
			var pan = player.getPanNorth();
			pan -= me._logo_tlc.ggFloorplanNorth;
			var filterpassed = true;
			var currentId = player.getCurrentNode();
			if (me._logo_tlc.ggFilteredIds.length > 0 && me._logo_tlc.ggFilteredIds.indexOf(currentId) == -1) filterpassed = false;
			if ((me._logo_tlc.ggSimpleFloorplanMarkerArray.hasOwnProperty(currentId)) && filterpassed) {
				var activeMarker = me._logo_tlc.ggSimpleFloorplanMarkerArray[currentId];
				if ((radar.radarElement) && (fov==radar.lastFov) && (pan==radar.lastPan) && (activeMarker.radarXPos==radar.xPos) && (activeMarker.radarYPos==radar.yPos)) return; 
				radar.lastPan=pan; radar.lastFov=fov;
				radar.xPos=activeMarker.radarXPos; radar.yPos=activeMarker.radarYPos;
				if (radar.radarElement) me._logo_tlc__mapdiv.removeChild(radar.radarElement);
				...
				me._logo_tlc__mapdiv.appendChild(radar.radarElement);
				var radarXPos = activeMarker.radarXPos - 180;
				var radarYPos = activeMarker.radarYPos - 180;
				radar.radarElement.style['position'] = 'absolute';
				radar.radarElement.style['left'] = '' + radarXPos + 'px';
				radar.radarElement.style['top'] = '' + radarYPos + 'px';
				radar.radarElement.style['z-index'] = me._logo_tlc.style['z-index'] + 1;
			} else {
				if (radar.radarElement) {
					me._logo_tlc__mapdiv.removeChild(radar.radarElement);
					radar.radarElement = null;
				}
			}
		}
		me._logo_tlc.ggShowSimpleFloorplan=function(mapDetails) {
			var mapWidth = me._logo_tlc.clientWidth;
			var mapHeight = me._logo_tlc.clientHeight;
			var levelLimit = 500;
			var level = 1;
			...
			var imageFilename = basePath + 'images/maptiles/' + me._logo_tlc.ggMapId + '_' + level + '.' + mapDetails['tileformat'];
			me._logo_tlc__img.setAttribute('src', imageFilename);
		me._logo_tlc__mapdiv.setAttribute('style','position: absolute; left: 0px; top: 0px;width:' + me._logo_tlc.ggFloorplanWidth + 'px;height:' + me._logo_tlc.ggFloorplanHeight + 'px;overflow:hidden;;');
		me._logo_tlc__img.setAttribute('style','width:' + me._logo_tlc.ggFloorplanWidth + 'px;height:' + me._logo_tlc.ggFloorplanHeight + 'px;-webkit-user-drag:none;pointer-events:none;');
		}
		me._logo_tlc.ggCalculateFloorplanSize=function(mapDetails) {
			var floorplanWidth = mapDetails['width'];
			var floorplanHeight = mapDetails['height'];
			var frameAR = me._logo_tlc.clientWidth / me._logo_tlc.clientHeight;
			var floorplanAR = floorplanWidth / floorplanHeight;
			if (frameAR > floorplanAR) {
				me._logo_tlc.ggFloorplanHeight = me._logo_tlc.clientHeight;
				me._logo_tlc.ggFloorplanWidth = me._logo_tlc.ggFloorplanHeight * floorplanAR;
			} else {
				me._logo_tlc.ggFloorplanWidth = me._logo_tlc.clientWidth;
				me._logo_tlc.ggFloorplanHeight = me._logo_tlc.ggFloorplanWidth / floorplanAR;
			}
		}
		me._logo_tlc.ggInitMap=function() {
			me._logo_tlc.ggMapNotLoaded = false;
			var mapDetails = player.getMapDetails(me._logo_tlc.ggMapId);
			me._logo_tlc.style.backgroundColor = mapDetails['bgcolor'];
			if (mapDetails.hasOwnProperty('transparent') && mapDetails['transparent']) {
				me._logo_tlc.ggPermeableMap = true;
			} else {
				me._logo_tlc.ggPermeableMap = false;
			}
			me._logo_tlc.ggCalculateFloorplanSize(mapDetails);
			me._logo_tlc.ggShowSimpleFloorplan(mapDetails);
			me._logo_tlc.ggFloorplanNorth = mapDetails['floorplannorth'];
		}
		me._logo_tlc.ggClearMap=function() {
			me._logo_tlc.ggClearMapMarkers();
			me._logo_tlc.ggMapNotLoaded = true;
		}
		me._logo_tlc.ggChangeMap=function(mapId) {
			var newMapType = player.getMapType(mapId)
			if (newMapType == 'web') {
				return;
			}
			me._logo_tlc.ggMapId = mapId;
			me._logo_tlc.ggClearMap();
			me._logo_tlc.ggInitMap();
			me._logo_tlc.ggInitMapMarkers();
		}
		me._logo_tlc.ggPlaceMarkersOnSimpleFloorplan=function() {
			var markers=me._logo_tlc.ggSimpleFloorplanMarkerArray;
			for (id in markers) {
				if (markers.hasOwnProperty(id)) {
					marker=markers[id];
					var coords = player.getNodeMapCoordsInPercent(id, me._logo_tlc.ggMapId);
					var xPos = (me._logo_tlc.ggFloorplanWidth * coords[0]) / 100.0;
					var yPos = (me._logo_tlc.ggFloorplanHeight * coords[1]) / 100.0;
					marker.radarXPos = xPos;
					marker.radarYPos = yPos;
					xPos -= me._logo_tlc.ggHMarkerAnchorOffset;
					yPos -= me._logo_tlc.ggVMarkerAnchorOffset;
					marker.style['position'] = 'absolute';
					marker.style['left'] = xPos + 'px';
					marker.style['top'] = yPos + 'px';
					marker.style['z-index'] = me._logo_tlc.style['z-index'] + 2;
				}
			}
		}
		me._logo_tlc.ggInitMapMarkers=function() {
			me._logo_tlc.ggClearMapMarkers();
			var ids = player.getNodeIds();
			me._logo_tlc.ggFilteredIds = [];
			if (me._logo_tlc.ggFilter != '') {
				var filter = me._logo_tlc.ggFilter.split(',');
				for (i=0; i < ids.length; i++) {
					var nodeId = ids[i];
					var nodeData = player.getNodeUserdata(nodeId);
					for (var j=0; j < filter.length; j++) {
						if (nodeData['tags'].indexOf(filter[j].trim()) != -1) me._logo_tlc.ggFilteredIds.push(nodeId);
					}
				}
				if (me._logo_tlc.ggFilteredIds.length > 0) ids = me._logo_tlc.ggFilteredIds;
			}
			for(var i=0; i < ids.length; i++) {
				var id = ids[i];
				var coords = player.getNodeMapCoordsInPercent(id, me._logo_tlc.ggMapId);
				if (coords.length>=2) {
					me._logo_tlc.ggHMarkerAnchorOffset = 20;
					me._logo_tlc.ggVMarkerAnchorOffset = 40;
					...
					me._logo_tlc.ggSimpleFloorplanMarkerArray[id] = marker;
					me._logo_tlc__mapdiv.appendChild(marker);
				}
			}
			me._logo_tlc.ggPlaceMarkersOnSimpleFloorplan();
			skin.updateSize(me._logo_tlc);
		}
		me._logo_tlc.ggClearMapMarkers=function() {
			for (id in me._logo_tlc.ggSimpleFloorplanMarkerArray) {
				if (me._logo_tlc.ggSimpleFloorplanMarkerArray.hasOwnProperty(id)) {
					me._logo_tlc__mapdiv.removeChild(me._logo_tlc.ggSimpleFloorplanMarkerArray[id]);
				}
			}
			me._logo_tlc.ggMarkerInstances=[];
			me._logo_tlc.ggSimpleFloorplanMarkerArray=[];
		}
		me._logo_rgf.ggMarkerInstances=[];
		me._logo_rgf.ggMapId = 'FloorPlan01';
		me._logo_rgf.ggLastNodeId=null;
		me._logo_rgf.ggSimpleFloorplanMarkerArray=[];
		me._logo_rgf.ggFloorplanWidth=0;
		me._logo_rgf.ggFloorplanHeight=0;
		me._logo_rgf__mapdiv=document.createElement('div');
		me._logo_rgf__mapdiv.className='ggskin ggskin_map';
		me._logo_rgf.appendChild(me._logo_rgf__mapdiv);
		me._logo_rgf__img=document.createElement('img');
		me._logo_rgf__img.className='ggskin ggskin_map';
		me._logo_rgf__mapdiv.appendChild(me._logo_rgf__img);
		me._logo_rgf.ggRadar={ lastFov : -1, lastPan : -1, xPos : -1, yPos : -1, radarElement : null }
		me._logo_rgf.ggRadar.update=function() {
			var radar=me._logo_rgf.ggRadar;
			var d2r = Math.PI/180 ;
			var fov = player.getFov();
			var pan = player.getPanNorth();
			pan -= me._logo_rgf.ggFloorplanNorth;
			var filterpassed = true;
			var currentId = player.getCurrentNode();
			if (me._logo_rgf.ggFilteredIds.length > 0 && me._logo_rgf.ggFilteredIds.indexOf(currentId) == -1) filterpassed = false;
			if ((me._logo_rgf.ggSimpleFloorplanMarkerArray.hasOwnProperty(currentId)) && filterpassed) {
				var activeMarker = me._logo_rgf.ggSimpleFloorplanMarkerArray[currentId];
				if ((radar.radarElement) && (fov==radar.lastFov) && (pan==radar.lastPan) && (activeMarker.radarXPos==radar.xPos) && (activeMarker.radarYPos==radar.yPos)) return; 
				radar.lastPan=pan; radar.lastFov=fov;
				radar.xPos=activeMarker.radarXPos; radar.yPos=activeMarker.radarYPos;
				if (radar.radarElement) me._logo_rgf__mapdiv.removeChild(radar.radarElement);
				radar.radarElement = document.createElementNS('http://www.w3.org/2000/svg','svg');
				radar.radarElement.setAttributeNS(null,'width',360);
				radar.radarElement.setAttributeNS(null,'height',360);
				radar.radarElement.setAttributeNS(null,'viewBox','0 0 360 360');
				...
				radarPath.setAttributeNS(null,'stroke-linejoin', 'miter');
				radar.radarElement.appendChild(radarPath);
				me._logo_rgf__mapdiv.appendChild(radar.radarElement);
				var radarXPos = activeMarker.radarXPos - 180;
				var radarYPos = activeMarker.radarYPos - 180;
				radar.radarElement.style['position'] = 'absolute';
				radar.radarElement.style['left'] = '' + radarXPos + 'px';
				radar.radarElement.style['top'] = '' + radarYPos + 'px';
				radar.radarElement.style['z-index'] = me._logo_rgf.style['z-index'] + 1;
			} else {
				if (radar.radarElement) {
					me._logo_rgf__mapdiv.removeChild(radar.radarElement);
					radar.radarElement = null;
				}
			}
		}
		me._logo_rgf.ggShowSimpleFloorplan=function(mapDetails) {
			var mapWidth = me._logo_rgf.clientWidth;
			var mapHeight = me._logo_rgf.clientHeight;
			var levelLimit = 500;
			var level = 1;
			while (mapWidth > levelLimit && mapHeight > levelLimit) {
				levelLimit *= 2;
			...
			var imageFilename = basePath + 'images/maptiles/' + me._logo_rgf.ggMapId + '_' + level + '.' + mapDetails['tileformat'];
			me._logo_rgf__img.setAttribute('src', imageFilename);
		me._logo_rgf__mapdiv.setAttribute('style','position: absolute; left: 0px; top: 0px;width:' + me._logo_rgf.ggFloorplanWidth + 'px;height:' + me._logo_rgf.ggFloorplanHeight + 'px;overflow:hidden;;');
		me._logo_rgf__img.setAttribute('style','width:' + me._logo_rgf.ggFloorplanWidth + 'px;height:' + me._logo_rgf.ggFloorplanHeight + 'px;-webkit-user-drag:none;pointer-events:none;');
		}
		me._logo_rgf.ggCalculateFloorplanSize=function(mapDetails) {
			var floorplanWidth = mapDetails['width'];
			var floorplanHeight = mapDetails['height'];
			var frameAR = me._logo_rgf.clientWidth / me._logo_rgf.clientHeight;
			var floorplanAR = floorplanWidth / floorplanHeight;
			if (frameAR > floorplanAR) {
				me._logo_rgf.ggFloorplanHeight = me._logo_rgf.clientHeight;
				me._logo_rgf.ggFloorplanWidth = me._logo_rgf.ggFloorplanHeight * floorplanAR;
			} else {
				me._logo_rgf.ggFloorplanWidth = me._logo_rgf.clientWidth;
				me._logo_rgf.ggFloorplanHeight = me._logo_rgf.ggFloorplanWidth / floorplanAR;
			}
		}
		me._logo_rgf.ggInitMap=function() {
			me._logo_rgf.ggMapNotLoaded = false;
			var mapDetails = player.getMapDetails(me._logo_rgf.ggMapId);
			me._logo_rgf.style.backgroundColor = mapDetails['bgcolor'];
			if (mapDetails.hasOwnProperty('transparent') && mapDetails['transparent']) {
				me._logo_rgf.ggPermeableMap = true;
			} else {
				me._logo_rgf.ggPermeableMap = false;
			}
			me._logo_rgf.ggCalculateFloorplanSize(mapDetails);
			me._logo_rgf.ggShowSimpleFloorplan(mapDetails);
			me._logo_rgf.ggFloorplanNorth = mapDetails['floorplannorth'];
		}
		me._logo_rgf.ggClearMap=function() {
			me._logo_rgf.ggClearMapMarkers();
			me._logo_rgf.ggMapNotLoaded = true;
		}
		me._logo_rgf.ggChangeMap=function(mapId) {
			var newMapType = player.getMapType(mapId)
			if (newMapType == 'web') {
				return;
			}
			me._logo_rgf.ggMapId = mapId;
			me._logo_rgf.ggClearMap();
			me._logo_rgf.ggInitMap();
			me._logo_rgf.ggInitMapMarkers();
		}
		me._logo_rgf.ggPlaceMarkersOnSimpleFloorplan=function() {
			var markers=me._logo_rgf.ggSimpleFloorplanMarkerArray;
			for (id in markers) {
				if (markers.hasOwnProperty(id)) {
					marker=markers[id];
					var coords = player.getNodeMapCoordsInPercent(id, me._logo_rgf.ggMapId);
					var xPos = (me._logo_rgf.ggFloorplanWidth * coords[0]) / 100.0;
					var yPos = (me._logo_rgf.ggFloorplanHeight * coords[1]) / 100.0;
					marker.radarXPos = xPos;
					marker.radarYPos = yPos;
					xPos -= me._logo_rgf.ggHMarkerAnchorOffset;
					yPos -= me._logo_rgf.ggVMarkerAnchorOffset;
					marker.style['position'] = 'absolute';
					marker.style['left'] = xPos + 'px';
					marker.style['top'] = yPos + 'px';
					marker.style['z-index'] = me._logo_rgf.style['z-index'] + 2;
				}
			}
		}
		me._logo_rgf.ggInitMapMarkers=function() {
			me._logo_rgf.ggClearMapMarkers();
			var ids = player.getNodeIds();
			me._logo_rgf.ggFilteredIds = [];
			if (me._logo_rgf.ggFilter != '') {
				var filter = me._logo_rgf.ggFilter.split(',');
				for (i=0; i < ids.length; i++) {
					var nodeId = ids[i];
					var nodeData = player.getNodeUserdata(nodeId);
					for (var j=0; j < filter.length; j++) {
						if (nodeData['tags'].indexOf(filter[j].trim()) != -1) me._logo_rgf.ggFilteredIds.push(nodeId);
					}
				}
				if (me._logo_rgf.ggFilteredIds.length > 0) ids = me._logo_rgf.ggFilteredIds;
			}
			for(var i=0; i < ids.length; i++) {
				var id = ids[i];
				var coords = player.getNodeMapCoordsInPercent(id, me._logo_rgf.ggMapId);
				if (coords.length>=2) {
					me._logo_rgf.ggHMarkerAnchorOffset = 20;
					me._logo_rgf.ggVMarkerAnchorOffset = 40;
					var marker = document.createElement('img');
					marker.setAttribute('src', basePath + 'images/_ggMapPin.png');
					marker.setAttribute('title', player.getNodeTitle(id));
					marker.style['width'] = '40px';
					...
					me._logo_rgf.ggSimpleFloorplanMarkerArray[id] = marker;
					me._logo_rgf__mapdiv.appendChild(marker);
				}
			}
			me._logo_rgf.ggPlaceMarkersOnSimpleFloorplan();
			skin.updateSize(me._logo_rgf);
		}
		me._logo_rgf.ggClearMapMarkers=function() {
			for (id in me._logo_rgf.ggSimpleFloorplanMarkerArray) {
				if (me._logo_rgf.ggSimpleFloorplanMarkerArray.hasOwnProperty(id)) {
					me._logo_rgf__mapdiv.removeChild(me._logo_rgf.ggSimpleFloorplanMarkerArray[id]);
				}
			}
			me._logo_rgf.ggMarkerInstances=[];
			me._logo_rgf.ggSimpleFloorplanMarkerArray=[];
		...
		player.addListener('configloaded', function() {
			...
			me._thumbnail_cloner.ggUpdate();
			me._thumbnail_cloner_mobile.ggUpdate();
			me._logo_tlc.ggInitMap(false);
			me._logo_tlc.ggInitMapMarkers(true);
			me._logo_rgf.ggInitMap(false);
			me._logo_rgf.ggInitMapMarkers(true);
		});
	...
	me.skinTimerEvent=function() {
		...
		me._logo_tlc.ggUpdateConditionTimer();
		me._logo_rgf.ggUpdateConditionTimer();
	...
	player.addListener('sizechanged', function(args) { me._tt_thumbnail_open.logicBlock_text();me._thumbnail_menu.logicBlock_visible();me._thumbnail_menu.logicBlock_alpha();me._thumbnail_menu_mobile.logicBlock_visible();me._thumbnail_menu_mobile.logicBlock_alpha();me._screentint.logicBlock_alpha(); });
	...
	player.addListener('changenode', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._controller.logicBlock_alpha();me._controller_slider.logicBlock_position();me._fullscreen_buttons.logicBlock_position();me._fullscreen_buttons.logicBlock_visible();me._gyro.logicBlock_position();me._gyro.logicBlock_visible();me._gyro_on.logicBlock_alpha();me._gyro_off.logicBlock_alpha();me._tt_gyro.logicBlock_text();me._projection_buttons.logicBlock_position();me._projection_buttons.logicBlock_visible();me._thumbnail.logicBlock_position();me._thumbnail.logicBlock_visible();me._tt_thumbnail_open.logicBlock_text();me._info.logicBlock_position();me._info.logicBlock_visible();me._autorotate_buttons.logicBlock_position();me._autorotate_buttons.logicBlock_visible();me._autorotate_start.logicBlock_alpha();me._autorotate_stop.logicBlock_alpha();me._tt_rotate.logicBlock_text();me._zoomout.logicBlock_visible();me._zoomin.logicBlock_visible();me._loading_multires.logicBlock_visible();me._thumbnail_menu.logicBlock_position();me._thumbnail_menu.logicBlock_visible();me._thumbnail_menu.logicBlock_alpha();me._thumbnail_menu_mobile.logicBlock_position();me._thumbnail_menu_mobile.logicBlock_visible();me._thumbnail_menu_mobile.logicBlock_alpha();me._loading.logicBlock_visible();me._screentint.logicBlock_alpha();me._web_page.logicBlock_visible();me._userdata.logicBlock_visible();me._information.logicBlock_visible();me._image_popup.logicBlock_visible();me._popup_image.logicBlock_visible();me._video_popup_file.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._video_popup_controls_file.logicBlock_visible();me._video_popup_url.logicBlock_visible();me._popup_video_url.logicBlock_visible();me._video_popup_controls_url.logicBlock_visible();me._video_popup_vimeo.logicBlock_visible();me._popup_video_vimeo.logicBlock_visible();me._video_popup_youtube.logicBlock_visible();me._popup_video_youtube.logicBlock_visible();me.__360image_gyro.logicBlock_visible();me.__360image.logicBlock_position();me.__360image.logicBlock_scaling();me._phone2.logicBlock_scaling();me._phone3.logicBlock_scaling();me._close.logicBlock_visible(); });
	...
	player.addListener('varchanged_vis_userdata', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._thumbnail_menu_mobile.logicBlock_position();me._screentint.logicBlock_alpha();me._userdata.logicBlock_visible(); });
	player.addListener('varchanged_vis_image_popup', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._screentint.logicBlock_alpha();me._image_popup.logicBlock_visible();me._popup_image.logicBlock_visible();me._close.logicBlock_visible(); });
	player.addListener('varchanged_vis_info_popup', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._screentint.logicBlock_alpha();me._information.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_popup_file', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._screentint.logicBlock_alpha();me._video_popup_file.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._video_popup_controls_file.logicBlock_visible();me._close.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_popup_url', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._screentint.logicBlock_alpha();me._video_popup_url.logicBlock_visible();me._popup_video_url.logicBlock_visible();me._video_popup_controls_url.logicBlock_visible();me._close.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_popup_vimeo', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._screentint.logicBlock_alpha();me._video_popup_vimeo.logicBlock_visible();me._popup_video_vimeo.logicBlock_visible();me._close.logicBlock_visible(); });
	player.addListener('varchanged_vis_video_popup_youtube', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._screentint.logicBlock_alpha();me._video_popup_youtube.logicBlock_visible();me._popup_video_youtube.logicBlock_visible();me._close.logicBlock_visible(); });
	player.addListener('varchanged_vis_website', function(args) { me._show_controller_button.logicBlock_position();me._controller.logicBlock_position();me._thumbnail_menu.logicBlock_position();me._screentint.logicBlock_alpha();me._web_page.logicBlock_visible();me._close.logicBlock_visible(); });
